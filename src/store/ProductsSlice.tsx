...
interface initProductsSliceInterface {
  firstRowProductsListData: IProduct[];
  secondRowProductsListData: IProduct[];
  thirdRowProductsListData: IProduct[];
}

// Each products row data
// first row has 2 products, second has 3 products, last has 1 product
// this data can be fetched from outsource

const initState: initProductsSliceInterface = {
